...
const FingerBoxCreator = () => {
	...
	return <>
		...
		<Grid size={{ xs:12, sm: 6, md: 4 }} spacing={2} container alignItems="center">
		...
		<Grid size={{ xs: 12, sm: 6, md: 2 }} container alignItems="center" justifyContent="flex-end">
			<Button
				size='small'
				variant="contained"
				onClick={generate}
	...
	return (
		<Container maxWidth="lg" disableGutters={true}>
			<Grid
				...
				spacing={2}
			>
				<Grid container size={{ md: 11, xs: 12 }}>
					<Card>
						<CardContent>
